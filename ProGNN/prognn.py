...
class ProGNN:
    ...
    def train_adj(self, epoch, features, adj, labels, idx_train, idx_val):
        ...
        loss_fro = torch.norm(estimator.estimated_adj - adj, p='fro')#Frobenius范数
...
class EstimateAdj(nn.Module):
    ...
    def __init__(self, adj, symmetric=False, device='cpu'):
        ...
        n = len(adj)
        self.estimated_adj = nn.Parameter(torch.FloatTensor(n, n)) #torch(n,n) 保存过滤后的adj
